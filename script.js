...
document.getElementById('area').addEventListener('change', function() {
    ...
    const areaName = areaNames[selectedArea] || '地域';
    document.getElementById("location").textContent = `選択した地域: ${areaName}`;

    // 選択された地域コードに基づいてURLを動的に変更
    const url = `https://www.jma.go.jp/bosai/forecast/data/forecast/${selectedArea}.json`;
